...
public class Queue<Item> implements Iterable<Item>{// "<Item>" Parametrizar
    ...
    private class QueueIterator implements Iterator<Item>{
        ...
        public QueueIterator(){ //construtor que atribui o current ao primeiro nó p/ começar
            current = first;
        }
        @Override
    ...
    public void addLast(Item item){
        if (isEmpty())
            ...
            linkedlist2.Node beforeLast = null;
            linkedlist2.Node last = first;

            while (last != null) {
                beforeLast = last;
                last = last.next;
            }
            linkedlist2.Node newNode = new linkedlist2.Node();
            newNode.item = item;
    ...
    public Queue(){ // construtor indicando os valores na lista
        first = null;
        n = 0;
    }
